...
def add_x_y_coords_offset_Opelucid_City(coords_status):
    ...
    if coords_status_copy["map_number_tuple"] == (2, 0, 132):
        ...
        coords_status_copy["y_coords"] = coords_status_copy["y_coords"] + 120
...
class Farming_Opelucid_City:
    def __init__(self, pokeMMO_instance: PokeMMO):
        self.p = pokeMMO_instance
        self.city = "Opelucid_City"
        self.my_df = self.p.df_dict["Opelucid_City_coords_tracking_csv"]
        self.farming_coords = [
            (x, y)
            for x, y, mark in zip(
    ...
    def run(self, repeat_times=10):
        ...
        while self.p.auto_strategy_flag:
            ...
            while self.p.get_gs()["return_status"] < 20:
                ...
                coords_status = add_x_y_coords_offset_Opelucid_City(self.p.get_coords())
...
if __name__ == "__main__":
    ...
    pokeMMO = PokeMMO()
    farming = Farming_Opelucid_City(pokeMMO)
    farming.run()
